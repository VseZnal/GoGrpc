...
func main() {
	...
	grpcServer := grpc.NewServer(
		grpc.UnaryInterceptor(protocreatemem.AccessLogInterceptor),
	)
	s := &protocreatemem.Server{}

	// attach the user service to the server
	protocreatemem.RegisterCreatememServiceServer(grpcServer, s)
